...
struct TodayWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = TodayWidgetAttributes(name: "Me")
    static let contentState = TodayWidgetAttributes.ContentState(value: 3)
